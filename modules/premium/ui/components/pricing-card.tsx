...
variants:{
    variant:{
            ...
            highlighted: "bg-gradient-to-br from-[#021F10] to-[#010D07] text-white",
    }
},
defaultVariants:{
    variant: "default",
...
onClick,
    ...
    <li key={index} className="flex items-center gap-x-2 w-full text-sm">
        <CircleCheck className={cn(pricingCardIconVariant({ variant }))} />
        {feature}
    </li>
))}
            </ul>
